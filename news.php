<?php 
	...
	if (!isset($action)) {
		...
		#dodan kod
		if ($action == 1) { 
			$vijest = 'US growth faster than expected';
            setcookie('vijest1', $vijest, time() + 86400, '/'); 
			print '
			...
			#dodan kod
			$vijest = 'Wall Street: Tech firm surge pushes US markets higher';
            setcookie('vijest2', $vijest, time() + 86400, '/');
			print '
			...
			#dodan kod
			$vijest = 'Hotel booking sites';
            setcookie('vijest3', $vijest, time() + 86400, '/');
			print '
